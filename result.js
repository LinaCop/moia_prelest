...
function renderResult(profData, evaluation, lppInfo) {
  ...
  return `
    <div class="r-card">
      <div class="r-topline">
        <span class="r-topline__badge">Результат проверки</span>
        <span class="r-topline__badge">СИЗ и ЛПП</span>
      </div>

      <div class="r-title">${title}</div>

      <div class="r-summary">
        <div class="r-summary__main">
          ...
          <div class="r-summary__text">
            Ниже приведён полный перечень обязательных СИЗ по выбранной профессии и сравнение с тем, что вы указали в форме.
          </div>
        </div>

        <div class="r-metrics">
          <div class="r-metric">
            <div class="r-metric__value">${evaluation.total}</div>
            <div class="r-metric__label">всего позиций</div>
          </div>
          <div class="r-metric">
            <div class="r-metric__value">${evaluation.okCount}</div>
            <div class="r-metric__label">соответствует</div>
          </div>
          <div class="r-metric">
            <div class="r-metric__value">${evaluation.badCount}</div>
            <div class="r-metric__label">несоответствий</div>
          </div>
        </div>
      </div>

      <div class="r-block">
        <div class="r-subtitle">Обязательные СИЗ по профессии</div>
      ...
      <div class="r-actions">
        ...
        <a class="r-btn r-btn--primary" href="page2.html">Открыть документы</a>
      </div>
    </div>
  `;
}
